...
public class homestudent_activity extends AppCompatActivity {
    Button logoutButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.homestudent_layout);
        ...
        progressDialog = new ProgressDialog(homestudent_activity.this);
        ...
        db.collection("user").document(userEmail)
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        Toast.makeText(homestudent_activity.this, "Data retrieved successfully!", Toast.LENGTH_SHORT).show();
                    } else {
                        // User document not found
                        Toast.makeText(homestudent_activity.this, "There was an error getting user info!", Toast.LENGTH_SHORT).show();
                        PerformAuthentication();
                    }
                })
                .addOnFailureListener(e -> {
                    PerformAuthentication();
                    Toast.makeText(homestudent_activity.this, "There was an unexpected error!", Toast.LENGTH_SHORT).show();
                });
    ...
    private void PerformAuthentication() {
        ...
        try {
            ...
            Toast.makeText(homestudent_activity.this, "Successfully logged out!", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(homestudent_activity.this, "Failed logging out.", Toast.LENGTH_SHORT).show();
        }
    }

    // Switch to Log In Activity Page after logging out
    private void sendUserToNextActivity () {
        Intent intent = new Intent(homestudent_activity.this, login_activity.class);
